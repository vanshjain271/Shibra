...
app.use(cors({
  origin: [
    'https://admin.shibrab2b.com',
    'https://www.admin.shibrab2b.com',
    'https://www.shibrab2b.com',
    'https://shibrab2b.com',
    'https://api.shibrab2b.com',
    /\.vercel\.app$/,
    /\.amplifyapp\.com$/, // Allow Amplify deployments // Allow all Vercel preview deployments
...
app.get('/', (req, res) => {
  ...
  res.json({
    success: true,
    message: 'Shibra API running 🚀',
    platform: 'Shibra B2B E-Commerce',
    version: '1.0.0',
    memory: {
